    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="px-4">
            <div className="space-y-2">
              {topHelpers.map((helper) => (
                <div
                  key={helper.rank}
                  className="flex items-center gap-4 p-4 rounded-lg hover:bg-muted transition-colors border"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <button className="p-0 h-auto justify-start" >
                      <Link to={`/profile/${helper.rank}`}>{helper.name}</Link>
                    </button>
                  ...
                  <div className="flex items-center gap-6 text-right">
                    ...
                    <button className="text-sm text-primary hover:underline bg-gray-300 px-2 py-0.5 rounded-sm font-medium" >
                      <Link to={`/profile/${helper.rank}`}>View</Link>
                    </button>
                  </div>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-semibold mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#2C7A7B] flex items-center justify-center text-sm">1</span>
                  Help Others
                </h4>
              ...
              <div>
                <h4 className="font-semibold mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#F59E0B] flex items-center justify-center text-sm">2</span>
                  Get Rated
                </h4>
                <p className="text-sm text-muted-foreground">
              ...
              <div>
                <h4 className="font-semibold mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-[#10B981] flex items-center justify-center text-sm">3</span>
                  Climb Ranks
                </h4>
                <p className="text-sm text-muted-foreground">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-muted-foreground">
            The leaderboard is updated daily based on community contributions.
          </p>
        </div>
      </main>
    </div>

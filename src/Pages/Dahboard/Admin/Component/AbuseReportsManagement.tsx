...
import { FiAlertTriangle, FiCheck, FiRefreshCw, FiSearch } from "react-icons/fi"
    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="bg-white px-4 py-2 rounded-lg shadow-sm">
          <p className="text-sm text-gray-600">Total: <span className="font-bold text-[#2C7A7B]">{filteredReports.length}</span></p>
        </div>
      </div>

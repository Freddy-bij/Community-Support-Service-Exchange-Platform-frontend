...
export default function Dashboard() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "messages": return <div className="animate-in fade-in duration-500"><Message /></div>;
      default:
        return (
  ...
  return (
    <div className="fixed inset-0 flex bg-[#F8FAFC] overflow-hidden z-[9999]">
        ...
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-3 bg-gray-50 px-4 py-2 rounded-xl border border-gray-100">
                ...
                <input type="text" placeholder="Search requests..." className="bg-transparent border-none outline-none text-sm w-48 lg:w-64" />
            </div>
          </div>
      ...
      {isModalOpen && <CreateOfferModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSuccess={handleRequestCreated} />}
